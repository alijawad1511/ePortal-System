        ...
        <div id="content" class="overflow-auto">
            ...
            <div class="card bg-white mb-2 p-4 rounded-0" id="content-wrapper">
                ...
                <?php
                    ...
                    if($result){
                        $assessmentInfo = mysqli_fetch_array($result);
                    }

                ?>

                <!-- Form Start -->
                <form action="edit_assessment.php?id=<?php echo $assessmentId;?>" method="POST">
                    ...
                    <div class="px-5 py-3 mb-5 border" id="assessment-input">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" required type="number" name="studentId" id="studentMobileNo" value="<?php echo $assessmentInfo['student_id'];  ?>" readonly>
                            <span class="text-danger font-weight-bold" id="studentIdError"></span>
                        </div>

                        <div class="form-group">
                            <label for="assessmentName">Assessment Name</label>
                            <input class="form-control" required type="text" name="assessmentName" id="assessmentName" placeholder="e.g. Monthly Test # 1" value="<?php echo $assessmentInfo['assessment_name']; ?>">
                            <span class="text-danger font-weight-bold" id="assessmentNameError"></span>
                        </div>

                        <div class="form-group">
                            <label for="subjectName">Subject Name</label>
                            <input class="form-control" required type="text" name="subjectName" id="subjectName"  placeholder="e.g. English" value="<?php echo $assessmentInfo['subject_title']; ?>">
                        ...
                        <div class="clearfix name-container">
                            ...
                            <div class="form-group float-right">
                                ...
                                <input type="number" name="obtainedMarks" required id="obtainedMarks" class="form-control" placeholder="e.g. 59" value="<?php echo $assessmentInfo['obtained_marks']; ?>">
                                <span class="text-danger font-weight-bold" id="obtainedMarksError"></span>
                            </div>
                        </div>


                        <button type="submit" class="btn btn-primary mt-2 w-100" name='submit'>Save Changes</button>
