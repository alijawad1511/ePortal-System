        ...
        <div id="content" class="overflow-auto">
                        ...
                        <div class="card p-2 bg-white shadow" id="dropdown">
                            <div class="useinfo p-2 mb-2 d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="text-dark font-weight-bold" id="user-id" style="font-size: 14px;">
                                        F2019266282</div>
                                </div>
                            </div>
            ...
            <div class="card bg-white mb-2 p-4 rounded-0" id="content-wrapper">
                ...
                <div class="card bg-white p-5 mb-3">
                    <div class="row">
                        <div class="col-4">
                            <img src="../assets/user-icon.png" class="border rounded" alt="Profile" width="250" height="250">
                        </div>
                        <div class="col-8">
                            <div class="row mb-2 bg-light">
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Name</label>
                                    <span class="text-muted"><?php echo $studentInfo['first_name']." ".$studentInfo['last_name']; ?></span>
                                </div>

                                <?php 

                                    $parentID = $studentInfo['parent_id'];
                                    
                                    $query = "SELECT first_name,last_name from Parents WHERE parent_id = '$parentID'";
                                    $result = mysqli_query($connection,$query);
                                    $parentName = mysqli_fetch_array($result);

                                ?>
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Father Name</label>
                                    <span class="text-muted"><?php echo $parentName['first_name']." ".$parentName['last_name']; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2 bg-light">
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Class</label>
                                    <span class="text-muted"><?php echo $studentInfo['class_name']; ?></span>
                                </div>
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Section</label>
                            ...
                            <div class="row mb-2 bg-light">
                                <div class="col-6">
                                    ...
                                    <span class="text-muted"><?php echo $studentInfo['cnic']; ?></span>
                                </div>
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Contact</label>
                                    <span class="text-muted"><?php echo $studentInfo['mobile_number']; ?></span>
                                </div>
                            </div>
                            <div class="row mb-2 bg-light">
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Email</label>
                                    <span class="text-muted"><?php echo $studentInfo['email']; ?></span>
                                </div>
                                <div class="col-6">
                                    <label class="font-weight-bold text-black d-block">Address</label>
                                    <span class="text-muted"><?php echo $studentInfo['address']; ?></span>
                                </div>
                            </div>
